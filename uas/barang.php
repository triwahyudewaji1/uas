...
$per_page=4; //menampilkan jumlah per page 4 records
...
<div class="content_b">
	<div class="main">
		<?php echo '<a href="form_tambah.php" class="btn btn-large" > Tambah Barang </a>'; ?>
		<form action="index.php" method="get">
			<label for="q"> Cari Data: </label>
			<input type="text" name="q" id="q" class="input-q" value="<?php echo $q ?>" >
		...
		<table>
			...
			<tr>
				...
				<td class="center">
					...
					href="hapus.php?id=<?php echo $row['id_barang'];?>"> Delete </a>
				</td>
			</tr>
			<?php endwhile; ?>
		</table>
